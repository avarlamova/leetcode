...
const countStations = (stationsCount, startStation, endStation) => {
    const clockwiseDistance = Math.abs(endStation - startStation)-1
    const counterClockwiseDistance = stationsCount-2-clockwiseDistance//(startStation+stationsCount)-endStation
    let answer = Math.min(counterClockwiseDistance, clockwiseDistance)
    return answer
}